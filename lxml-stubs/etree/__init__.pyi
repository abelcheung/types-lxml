...
class _Element:
    ...
    @overload
    def itersiblings(self, *tags: _TagSelector, preceding: bool = ...) -> Iterator[Self]: ...
    @overload
    def iterancestors(self, *, tag: _TagSelector | None = ...) -> Iterator[Self]: ...
    @overload
    def iterancestors(self, *tags: _TagSelector) -> Iterator[Self]: ...
    @overload
    ...
    @overload
    def iterchildren(self, *tags: _TagSelector, reversed: bool = ...) -> Iterator[Self]: ...
    @overload
