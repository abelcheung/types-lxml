...
class _Element:
    ...
    @overload
    def itersiblings(
        self, *, tag: _t._TagSelector | None = ..., preceding: bool = ...
    ) -> Iterator[Self]: ...
    @overload
    ...
    @overload
    def iterancestors(self, *, tag: _t._TagSelector | None = ...) -> Iterator[Self]: ...
    @overload
    def iterancestors(  # pyright: ignore[reportOverlappingOverload]
        self, *tags: _t._TagSelector
    ) -> Iterator[Self]: ...
    @overload
    def iterdescendants(
        self, *, tag: _t._TagSelector | None = ...
    ) -> Iterator[Self]: ...
    @overload
    ...
    @overload
    def iterchildren(
        self, *, tag: _t._TagSelector | None = ..., reversed: bool = ...
    ) -> Iterator[Self]: ...
    @overload
    ...
    @overload
    def iter(self, *, tag: _t._TagSelector | None = ...) -> Iterator[Self]: ...
    @overload
    def itertext(
        self, *, tag: _t._TagSelector | None = ..., with_tail: bool = ...
    ) -> Iterator[str]: ...
    @overload
