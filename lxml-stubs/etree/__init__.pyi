...
class _Element:
    ...
    @overload
    def itersiblings(self, *, tag: _TagSelector | None = ..., preceding: bool = ...) -> Iterator[Self]: ...
    @overload
    def itersiblings(self, *tags: _TagSelector, preceding: bool = ...) -> Iterator[Self]: ...  # pyright: ignore[reportOverlappingOverload]
    @overload
    def iterancestors(self, *, tag: _TagSelector | None = ...) -> Iterator[Self]: ...
    @overload
    def iterancestors(self, *tags: _TagSelector) -> Iterator[Self]: ...  # pyright: ignore[reportOverlappingOverload]
    @overload
    def iterdescendants(self, *, tag: _TagSelector | None = ...) -> Iterator[Self]: ...
    @overload
    def iterdescendants(self, *tags: _TagSelector) -> Iterator[Self]: ...  # pyright: ignore[reportOverlappingOverload]
    @overload
    def iterchildren(self, *, tag: _TagSelector | None = ..., reversed: bool = ...) -> Iterator[Self]: ...
    @overload
    def iterchildren(self, *tags: _TagSelector, reversed: bool = ...) -> Iterator[Self]: ...  # pyright: ignore[reportOverlappingOverload]
    @overload
    def iter(self, *tags: _TagSelector) -> Iterator[Self]: ...
    @overload
    def iter(self, *, tag: _TagSelector | None = ...) -> Iterator[Self]: ...
    @overload
    def itertext(self, *, tag: _TagSelector | None = ..., with_tail: bool = ...) -> Iterator[str]: ...
    @overload
    def itertext(self, *tags: _TagSelector, with_tail: bool = ...) -> Iterator[str]: ...  # pyright: ignore[reportOverlappingOverload]
    def makeelement(
        self,
        _tag: _TagName,
        /,
